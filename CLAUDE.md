...
Minecraft Forge 1.20.1 AI agent mod — Multi-agent system with named FakePlayers, persona-based roles, scoped memory, and schedule-based automation. Each agent runs its own Claude Agent SDK runtime with filtered MCP tools. An Agent Manager runtime orchestrates schedules and coordinates agents.
